...
helm repo update
helm install --namespace=traefik traefik traefik/traefik --values=rke2lab/traefik-install/traefik/values.yaml
kubectl apply -f rke2lab/traefik-install/traefik/default-headers.yaml
