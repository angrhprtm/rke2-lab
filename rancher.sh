...
lbrange=172.16.20.70-172.16.20.119
...
echo "172.16.20.5 admin" | sudo tee -a /etc/hosts
echo "172.16.20.51 master1" | sudo tee -a /etc/hosts
echo "172.16.20.52 master2" | sudo tee -a /etc/hosts
echo "172.16.20.53 master3" | sudo tee -a /etc/hosts
echo "172.16.20.61 worker1" | sudo tee -a /etc/hosts
echo "172.16.20.62 worker2" | sudo tee -a /etc/hosts
wait
sudo cat /etc/hosts
...
helm install rancher rancher-latest/rancher \
 ...
 --set hostname=rancher.anugerahpratama.id \
